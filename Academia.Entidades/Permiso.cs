namespace Academia.Entidades
{
    public class Permiso
    {
        ...
        public Permiso(int id, string nombre, string descripcion, string categoria, bool habilitado = true)
        {
            SetId(id);
            SetNombre(nombre);
        ...
        private Permiso() { } // Constructor sin parámetros para Entity Framework
